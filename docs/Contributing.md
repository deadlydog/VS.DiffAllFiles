...
- VS.DiffAllFiles.VS2019 - Throughout the patch releases of VS2019, Git functionality was slowly moved from the TeamExplorer window to a new window. As of now, no extensibility points have been documented for this new window, so recent versions of VS2019 will not benefit from this extension for Git.
...
- [Things to test after making changes or new versions][ThingsToTestAfterMakingChangesPage]
...
[ThingsToTestAfterMakingChangesPage]: Contributing/ThingsToTestAfterMakingChanges.md
